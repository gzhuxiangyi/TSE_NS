...
public class Individual implements Comparable<Individual> {
    ...
    private static SimilarityTechnique st = new SimilarityTechnique(SimilarityTechnique.Anti_Dice_Distance, SimilarityTechnique.GREEDY_SEARCH);
    ...
    public void mutate(int mutateType) throws Exception {
        ...
        Product p;
        do {
            p = SPL.getInstance().getUnpredictableProduct();
