...
public abstract class Problem implements Serializable {
  ...
  /**
   * Stores the problem full name, used in TSP,mTSP,QAP and mQAP etc.
   */
  protected String problemFullName_ ;
  
//  /**
//   * Stores the problem full name,used in TSP, mTSP , QAP ant mQAP etc.
//   */
//  protected String problemFullName_ ;
...
//   */
  ...
  /**
   * Get the data of a problem, such as the city distances in TSP
   * @param solution The <code>Solution</code> to evaluate.
   */    
//  public abstract int [][] readData(String dataType) throws JMException ;    
  ...
  //Change the ith lower limit of the problem, used in MCMOABC algorithm
  public void setLowerLimit(int i, double value){
	  lowerLimit_[i] = value;
  }//setLowerLimit
  
  //Change the ith upper limit of the problem, used in MCMOABC algorithm
  public void setUperLimit(int i, double value){
	  upperLimit_[i] = value;
  }//setUperLimit

public String getProblemFullName_() {
	return problemFullName_;
}

public void setProblemFullName_(String problemFullName_) {
	this.problemFullName_ = problemFullName_;
}

public int[][] readData(String dataType) throws JMException {
