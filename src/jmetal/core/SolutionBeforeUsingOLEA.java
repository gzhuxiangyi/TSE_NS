 ...
 */
public class SolutionBeforeUsingOLEA implements Serializable {  
...
//	private  SolutionSet pbest_ ;
   ...
   * Constructor.
   */
  public SolutionBeforeUsingOLEA() {        
  	problem_                      = null  ;
    marked_                       = false ;
    isNormalized_                 = false;
...
//    speed_                        = null ;
   ...
   */
  public SolutionBeforeUsingOLEA(int numberOfObjectives) {
   ...
   * variables of a SolutionSet to apply quality indicators
   */
  public SolutionBeforeUsingOLEA(int numberOfObjectives,int numberOfVariables) {
    numberOfObjectives_ = numberOfObjectives;    
    numberOfConstraints_= 0;
    objective_          = new double[numberOfObjectives];
    normalizedObjective_ = new double[numberOfObjectives];
...
//    speed_         = new double[numberOfVariables];
   ...
   */
  public SolutionBeforeUsingOLEA(Problem problem) throws ClassNotFoundException{
    problem_ = problem ; 
...
//    pbest_          = new SolutionSet(3);
  ...
  static public SolutionBeforeUsingOLEA getNewSolution(Problem problem) throws ClassNotFoundException {
    return new SolutionBeforeUsingOLEA(problem) ;
  }
   ...
   * @param problem The problem to solve
   */
  public SolutionBeforeUsingOLEA(Problem problem, Variable [] variables){
    problem_ = problem ;
  	type_ = problem.getSolutionType() ;
    numberOfObjectives_ = problem.getNumberOfObjectives() ;
    numberOfConstraints_ = problem.getNumberOfConstraints();
...
//    speed_         = new double[numberOfVariables()];
   ...
   */    
  public SolutionBeforeUsingOLEA(SolutionBeforeUsingOLEA solution) {            
...
//     pbest_ = solution.getPbest();   
   ...
   * @param solution Solution to copy.
   */    
  public SolutionBeforeUsingOLEA(SolutionBeforeUsingOLEA solution, boolean copyObjOnly) {            
    numberOfObjectives_ = solution.numberOfObjectives(); 
    objective_ = new double[numberOfObjectives_];
    constraint_    = new double[numberOfConstraints_];
