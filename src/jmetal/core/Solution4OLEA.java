 ...
 */
public class Solution4OLEA implements Serializable {  
	/**
	 * Stores the problem 
	 */
...
/**
   ...
   */
	private int clusterID_, NadirclusterID_;
	private int clusterID2_, NadirclusterID2_;
	...
	*/
	...
	private double associateDist_, NadirassociateDist_;	
	private double associateDist2_, NadirassociateDist2_;	
   ...
   */
  public Solution4OLEA(int numberOfObjectives) {
   ...
   * variables of a SolutionSet to apply quality indicators
   */
  public Solution4OLEA(int numberOfObjectives,int numberOfVariables) {
    numberOfObjectives_ = numberOfObjectives;
    numberOfConstraints_= 0;
    objective_          = new double[numberOfObjectives];
    normalizedObjective_ = new double[numberOfObjectives];
   ...
   */
  public Solution4OLEA(Problem problem) throws ClassNotFoundException{
    problem_ = problem ; 
  ...
  static public Solution4OLEA getNewSolution(Problem problem) throws ClassNotFoundException {
    return new Solution4OLEA(problem) ;
  }
   ...
   * @param problem The problem to solve
   */
  public Solution4OLEA(Problem problem, Variable [] variables){
    problem_ = problem ;
  	type_ = problem.getSolutionType() ;
    numberOfObjectives_ = problem.getNumberOfObjectives() ;
    numberOfConstraints_ = problem.getNumberOfConstraints();
   ...
   */    
  public Solution4OLEA(Solution4OLEA solution) {            
    ...
    clusterID2_ = solution.getClusterID2(); // Added by Yi
    vDistance_   = solution.getVDistance();
    // Used in MOEADD
    diversity_       = solution.getDiversity();
    associateDist_   = solution.getAssociateDist();   
    associateDist2_  = solution.getAssociateDist2();// Added by Yi
    region_          = solution.readRegion();
    
    // Used in OLEA, added by Yi 
    NadirclusterID_       = solution.getNadirClusterID();
    NadirclusterID2_      = solution.getNadirClusterID2();
    NadirassociateDist_   = solution.getNadirAssociateDist();
    NadirassociateDist2_  = solution.getNadirAssociateDist2();
  } // Solution
   ...
   * @param solution Solution to copy.
   */    
  public Solution4OLEA(Solution4OLEA solution, boolean copyObjOnly) {            
    numberOfObjectives_ = solution.numberOfObjectives(); 
    objective_ = new double[numberOfObjectives_];
    constraint_    = new double[numberOfConstraints_];
...
/**
  ...
  public int getNumberOfBits() {
	...
	public void setClusterID2(int clusterID2_) {
		this.clusterID2_ = clusterID2_;
	}
	
	public int getNadirClusterID() {
		return NadirclusterID_;
	}
	
	public void setNadirClusterID(int NadirclusterID_) {
		this.NadirclusterID_ = NadirclusterID_;
	}
	
	public int getNadirClusterID2() {
		return NadirclusterID2_;
	}
	
	public void setNadirClusterID2(int NadirclusterID2_) {
		this.NadirclusterID2_ = NadirclusterID2_;
	}
	...
	public double getAssociateDist2() {
		return associateDist2_;
	}

	public void setAssociateDist2(double associateDist2_) {
		this.associateDist2_ = associateDist2_;
	}
	public double getNadirAssociateDist() {
		return NadirassociateDist_;
	}

	public void setNadirAssociateDist(double NadirassociateDist_) {
		this.NadirassociateDist_ = NadirassociateDist_;
	}
	public double getNadirAssociateDist2() {
		return NadirassociateDist2_;
	}

	public void setNadirAssociateDist2(double NadirassociateDist2_) {
		this.NadirassociateDist2_ = NadirassociateDist2_;
	}
