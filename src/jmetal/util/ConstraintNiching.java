...
public class ConstraintNiching {
	...
	public ConstraintNiching(SolutionSet population, SolutionSet lastFront,
...
//				if (mgPopulation.get(i).getOverallConstraintViolation()==0.0) {
